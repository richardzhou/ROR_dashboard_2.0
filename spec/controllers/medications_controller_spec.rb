  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved medication as @medication" do
        ...
        post :create, {:medication => { "name" => "invalid value" }}, valid_session
        assigns(:medication).should be_a_new(Medication)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested medication" do
        ...
        Medication.any_instance.should_receive(:update_attributes).with({ "name" => "MyString" })
        put :update, {:id => medication.to_param, :medication => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the medication as @medication" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Medication.any_instance.stub(:save).and_return(false)
        put :update, {:id => medication.to_param, :medication => { "name" => "invalid value" }}, valid_session
        assigns(:medication).should eq(medication)
      end
